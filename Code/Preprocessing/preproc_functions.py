...
def IndxVariableGenes(mean_genes, disp_genes, mean_low_cutoff, mean_high_cutoff, disp_low_cutoff, disp_high_cutoff, zero_type):
    ...
    if (zero_type == 1):
        ...
        plt.ylabel('Dispersion')
        plt.title('Highly Variable Genes')
        plt.savefig("Figures/scatter_hvg_mean_disp_in.png")
        ...
        plt.ylabel('Dispersion')
        plt.title('Highly Variable Genes')
        plt.savefig("Figures/scatter_hvg_log_mean_disp_in.png")
    ...
    if (zero_type == 2):
        ...
        plt.ylabel('Dispersion')
        plt.title('Highly Variable Genes')
        plt.savefig("Figures/scatter_hvg_mean_disp_out.png")
        ...
        plt.ylabel('Dispersion')
        plt.title('Highly Variable Genes')
        plt.savefig("Figures/scatter_hvg_log_mean_disp_out.png")
